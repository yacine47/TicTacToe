...
class AutoPlayView extends StatefulWidget {
  const AutoPlayView({super.key});
  static String id = 'AutoPlayView';

  @override
  State<AutoPlayView> createState() => _AutoPlayViewState();
}

class _AutoPlayViewState extends State<AutoPlayView> {
  final random = Random();
  String? winner;
  bool endGame = false;
  int counter = 0;
